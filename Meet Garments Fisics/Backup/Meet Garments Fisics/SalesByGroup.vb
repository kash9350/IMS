...
Public Class SalesByGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Meet_Garments_Fisics.SalesByGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByGroup = New SalesByGroup
        rpt.Site = Me.Site
        Return rpt
    End Function
