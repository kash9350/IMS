...
Public Class PurcFromSupplierR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Meet_Garments_Fisics.PurcFromSupplierR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurcFromSupplierR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurcFromSupplierR = New PurcFromSupplierR
        rpt.Site = Me.Site
        Return rpt
    End Function
