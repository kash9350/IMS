...
Public Class SalestoCustomerR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Meet_Garments_Fisics.SalestoCustomerR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalestoCustomerR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalestoCustomerR = New SalestoCustomerR
        rpt.Site = Me.Site
        Return rpt
    End Function
